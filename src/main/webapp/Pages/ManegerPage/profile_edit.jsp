		...
		<div class="row">
			<div class="col-md-3 border-right">
				<div
					...
					<img class="rounded-circle mt-5" width="150px"
						src="<%=client.getImage()%>"><span class="font-weight-bold">Ảnh đại diện</span><span>
					</span>
				</div>
			</div>
			<div class="col-md-9 border-right">
				<div class="d-flex justify-content-between align-items-center my-3">
					<h4 class="text-right">Ảnh đại diện</h4>
				</div>
				<div class="row mt-3">
			...
			<div class="col-md-12 border-right">
				<div class="p-3 py-5">
					...
					<div class="row mt-2">
						<div class="col-md-12">
							<label class="labels">Tên tài khoản</label><input type="text"
								class="form-control" placeholder="enter username" name="user"
								value="<%=client.getUser()%>">
						</div>
						<div class="col-md-12">
							<label class="labels">Mật khẩu</label><input type="password"
					...
					<div class="mt-5 text-center">
						<button class="btn btn-primary profile-button" type="button" href="<%=request.getContextPath()%>/Trangchu/Account?setting">Lưu
							</button>

						<a class="btn btn-secondary " href="<%=request.getContextPath()%>/Trangchu/Account">Quay lại</a>
					</div>
				</div>
			</div>
		</div>
